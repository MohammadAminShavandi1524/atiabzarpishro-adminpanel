...
interface BrandCatalogUploadFieldProps {
  value?: File;
...
export default function BrandCatalogUploadField({
  value,
  onChange,
  error,
  progress,
  isUploading,
  isFinalizing,
}: BrandCatalogUploadFieldProps) {
  const t = useTranslations("addBrand");

  return (
    <div>
      <label className="text-foreground mb-2 block text-sm font-medium">
        {t("form.catalog.label")}
      </label>
